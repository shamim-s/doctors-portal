...
const About = require('../../Pages/About/About').default;
const Appointment = require('../../Pages/Appointment/Appointment/Appointment').default;
const Contact = require('../../Pages/Contact/Contact').default;
const Home = require('../../Pages/Home/Home/Home').default;
const Login = require('../../Pages/Login/Login').default;
const Register = require('../../Pages/Register/Register').default;
const Reviews = require('../../Pages/Reviews/Reviews').default;
